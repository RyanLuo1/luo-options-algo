...
### Screener modes — Income · Upside (2026-09-15) — NOT yet deployed

**Upside is a calculator, not a recommender.** The same three legs built for a wide call spread and a small credit; the Income ranking is the backtested product and Upside says so on every screen ("Not backtested — calculator only"). Brief: `.impeccable/surfaces/web-src-app-jsx.md` § Upside mode (local only).
