...
try {
  ...
  log('the editor opens read-only for a thin-quote setup', /Thin-quote setup · Tier 1 · read-only/.test(await body()) && (await page.getByRole('button', { name: /Recalculate|Save/ }).count()) === 0 && /can’t be edited against the live chain or saved/.test(await body()))
