...
export default function RankedTable({
  ...
  mode = 'income',                       // the mode toggle switches between each mode's own results; the table never mixes them
}) {
