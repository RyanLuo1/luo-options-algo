 ...
 */
export function NoResults({ tickersUsed, tickersSkipped, marketOpen, reasons = {}, reasonCodes = {}, minCredit, minRocPct = 0, mode = 'income', minUpsidePct = 0, onLowerRoc, onFocusTickers }) {
